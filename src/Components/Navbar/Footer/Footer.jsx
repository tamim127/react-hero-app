...
const Footer = () => {
  return (
    <footer
      className="bg-black text-white inter bg-cover  bg-center"
      style={{
    ...
    >
      ...
      <div className="max-w-screen-xl  mx-auto px-6 py-6 flex flex-col items-center gap-6">
        <div className="flex gap-5">
          <a href="#" className=" text-white hover:text-purple-500 dark:hover:text-white">
          ...
          <a href="#" className=" text-white hover:text-purple-500 dark:hover:text-white ms-5">
            <svg className="w-5 h-5"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
          ...
          <a href="#" className=" text-white hover:text-purple-500 dark:hover:text-white ms-5">
            ...
            <span className="sr-only">Dribbble account</span> </a>
        </div>
